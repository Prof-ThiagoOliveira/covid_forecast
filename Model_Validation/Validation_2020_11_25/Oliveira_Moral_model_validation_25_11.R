...
# coda samples - MCMC
#=======================================================================
save(runJagsOut, file = "JAGSForecast6.RData")
...
#-----------------------------------------------------------------------
save(data_forecast, file = "data_forecast.RData")
#load("data_forecast6.RData")
#-----------------------------------------------------------------------
...
ggsave("accuracy1.pdf",  width = 5,  height = 3)
#=======================================================================
# initial forecast
#=======================================================================
...
ggsave("countries1.pdf",  width = 7,  height = 7)
